    ...
    return [
        ...
        },
        {
            ...
            handler: (request, reply) => {
                ...
                const rawResetToken = Uuid({ rng: Uuid.nodeRNG });

                Bcrypt.hash(rawResetToken, 10, (err, resetToken) => {
            ...
            handler: (request, reply) => {
                ...
                Users.query()
                    ...
                    .asCallback((err, foundUser) => {
                        ...
                        Bcrypt.compare(Payload.resetToken, foundUser.resetToken, (bcryptErr, isValid) => {
                            ...
                            if (!isValid) {
                                return reply(Boom.unauthorized('Email and token do not match'));
                            }
